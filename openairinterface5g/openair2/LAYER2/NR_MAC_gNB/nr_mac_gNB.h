...
typedef struct gNB_MAC_INST_s {
  ...
  /* PRB calculation (seyeon)*/
  atomic_uint_fast32_t dl_prb_used_acc;   // 누적 사용 PRB
  atomic_uint_fast32_t dl_prb_total_acc;  // 누적 총 PRB
  atomic_uint_fast32_t util_window_slots; // 윈도우 내 슬롯 수
  _Atomic float        dl_prb_util_avg;   // 0.0 ~ 1.0
